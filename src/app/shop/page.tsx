            ...
            <div className="bg-white p-6 rounded-xl border border-brand-muted/20 sticky top-24 shadow-sm">
              ...
              {availableColors.length > 0 && (
                <div className="mb-6">
                  ...
                  <div className="space-y-3">
                    <Link href={filterHref({ color: undefined })} className={`block text-sm ${!colorFilter ? 'font-bold text-brand-primary' : 'text-brand-deep hover:text-brand-primary'}`}>
                      All Colors
                    </Link>
                    {availableColors.map((c) => (
                      ...
                      >
                        <span className="w-3 h-3 rounded-full border border-gray-300 inline-block" style={{ backgroundColor: c === 'white' ? '#fff' : c === 'navy' ? '#000080' : c }}></span>
                        {c}
                      </Link>
                    ))}
                  </div>
                  ...
                  <div key={product.id} className="group flex flex-col bg-white rounded-lg overflow-hidden border border-brand-muted/20 hover:shadow-xl transition-all duration-300">
                    ...
                    <div className="p-5 flex flex-col flex-grow">
                      <div className="flex justify-between items-start mb-2">
                        <div className="text-xs text-brand-natural font-semibold uppercase tracking-wider">
